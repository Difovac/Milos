...
const char * const BITCOIN_CONF_FILENAME = "trident.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "trident";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/trident";
#else
    // Unix
    return pathRet / ".trident";
#endif
#endif
}
