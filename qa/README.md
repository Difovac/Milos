...
```
  ...
  --nocleanup           Leave tridentds and test.* datadir on exit or error
  --noshutdown          Don't stop tridentds after the test execution
  --srcdir=SRCDIR       Source directory containing tridentd/trident-cli
                        (default: ../../src)
