...
*Setup instructions for a Gitian build of trident Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the trident
...
- [Building trident Core](#building-litecoin-core)
...
To build trident Core (for Linux, OS X and Windows) just follow the steps under 'perform
