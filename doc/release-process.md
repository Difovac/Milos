...
### trident maintainers/release engineers, update version in sources
...
### Build and sign trident Core for Linux, Windows, and OS X:
...
- Announce the release:
  ...
  - blog.trident.org blog post

  - Update title of #litecoin and #litecoin-dev on Freenode IRC

  - Optionally twitter, reddit /r/trident, ... but this will usually sort out itself
